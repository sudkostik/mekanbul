...
if(mesafe>1) {
    ...
    yeniMesafe=parseInt(mesafe*1000,10); //10'luk düzende.
    birim=" m";
}

return yeniMesafe+birim; //string ve sayıyla birleştirse ikisi de string olur.
}

var anaSayfaOlustur=function(res,mekanListesi){
    var mesaj;
    if(!(mekanListesi instanceof Array)){ //bu mekanlistesi array türünden olucak.
...
const yorumumuEkle=function(req, res) {
    ...
    mekanid= req.params.mekanid; //mekan id yi params ifadesiyle alabiliyoruz.
